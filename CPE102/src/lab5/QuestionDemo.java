...
public class QuestionDemo {
	public static void main(String[] args) {
		...
		MultiChoiceQuestion question0 = new MultiChoiceQuestion("Which countries are in Africa?");
		...
		MultiChoiceQuestion question1 = new MultiChoiceQuestion("Which of the following are vegetables?");
